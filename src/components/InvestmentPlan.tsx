      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        {(() => {
          ...
          for (let y = 1; y <= yearsToProject; y++) {
            ...
            const metaIncome = (incluyeCredito ? totalReturn : dividends) + (aporteCuentaMeta ? monthly : 0);
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                <div className="bg-slate-50 rounded-lg p-3 border border-slate-200">
                  ...
                  <label className="flex items-center gap-1.5 mt-1 cursor-pointer select-none">
                    <input type="checkbox" checked={aporteCuentaMeta} onChange={e => setAporteCuentaMeta(e.target.checked)}
                      className="w-3 h-3 rounded border-slate-300 text-teal-600 focus:ring-teal-500/20" />
